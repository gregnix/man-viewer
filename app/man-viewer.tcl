...
# Helper analog zu bin/_paths.tcl
...
if {[catch {package require mvdebug 0.2} err]} {
    puts stderr "Warning: mvdebug nicht ladbar: $err"
}
package require nroffparser 0.2
package require nroffrenderer 0.1
package require mvmanindex 0.1
package require mvconfig 0.1

# DocIR-Pipeline (im separaten ../docir/-Repo bzw. ~/lib/tcltk/docir)
...
# ============================================================
# Einstellungsdialog + Export (ausgelagert)
# ============================================================

source [file join $scriptDir mv_settings.tcl]
source [file join $scriptDir mv_export.tcl]
...
.menubar.file add command -label "Export as Markdown…" \
    -command exportMarkdown -accelerator "Ctrl+M"
.menubar.file add separator
