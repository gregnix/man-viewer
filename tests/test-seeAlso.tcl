...
test "seeAlso.html.local" {
    ...
    set html [docir::html::render $ir [dict create standalone 0 linkMode local]]
    assert [expr {[string match "*scrollbar.n.html*" $html]}] "Lokale URL: scrollbar.n.html"
...
test "seeAlso.html.online_TkCmd" {
    ...
    set ast [nroffparser::parse $src "canvas.n"]
    set ir  [docir::roff::fromAst $ast]
    set html [docir::html::render $ir [dict create standalone 0 linkMode online]]
    assert [expr {[string match "*TkCmd/scrollbar*" $html]}] "TkCmd fuer Tk-Seite: $html"
}
...
test "seeAlso.html.online_TclCmd" {
    ...
    set ir  [docir::roff::fromAst $ast]
    set html [docir::html::render $ir [dict create standalone 0 linkMode online]]
    assert [expr {[string match "*TclCmd/regexp*" $html]}] "TclCmd fuer Tcl-Seite"
}
...
test "seeAlso.html.anchor" {
    ...
    set ast [nroffparser::parse $src "canvas.n"]
    set ir  [docir::roff::fromAst $ast]
    set html [docir::html::render $ir [dict create standalone 0 linkMode anchor]]
